...
Run: .venv/bin/python queries/first_move_speed.py [--user <username>]
"""
import argparse
import os
import re
...
USERNAME = args.user
if not USERNAME:
    parser.error("No username provided. Pass --user or set CHESS_USERNAME.")

DB = f"data/{USERNAME}.duckdb"
